...
public class MainActivity extends AppCompatActivity {
    ...
    private void prepareRoomData() {
        Room room = new Room("1", "LivingRoom", false, R.drawable.living_room);
        roomList.add(room);
        room = new Room("2", "Kitchen",false, R.drawable.kitchen);
        roomList.add(room);
        room = new Room("3", "Bedroom",false, R.drawable.bedroom);
        roomList.add(room);
        room = new Room("4", "Bathroom",false, R.drawable.bathroom);
        roomList.add(room);
